...
export default function App() {
  ...
  function add() {
    ...
    setTimeout(() => {
      const input = document.querySelector('input[placeholder="New note"]');
      input?.focus();
    }, 100);
  }
    ...
    function handleKeyDown(e) {
      if (e.ctrlKey || e.metaKey) {
        switch (e.key) {
          ...
          case 'n':
            e.preventDefault();
            const addInput = document.querySelector('input[placeholder="New note"]');
            addInput?.focus();
            break;
        }
      }
  ...
  return (
    <div style={styles.main}>
      ...
      <div style={styles.container}>
        <h1 style={styles.title}>Notes App (JavaScript)</h1>
          ...
          {processedNotes.map(n => (
            ...
            >
              ...
              <button 
                ...
                onKeyDown={(e) => {
                  if (e.key === 'ArrowLeft') {
                    const toggleBtn = e.currentTarget.previousElementSibling;
                    toggleBtn?.focus();
                  }
                }}
              >
